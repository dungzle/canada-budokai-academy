          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
              <div className="lg:col-span-6 space-y-4 text-neutral-600 leading-relaxed">
                ...
                <p>
                  During the war, DNBK came under direct control of the
                  government and military, leading to the loss of its original
                  independence. Following Japan’s defeat in 1945, Allied
                  occupation authorities ordered the organization to dissolve in
                  1946, confiscating its property and removing its leadership.
                </p>
                <p>
                  In 1953, after Japan regained sovereignty, DNBK was
                  reestablished and returned to its original ideals, focusing on
                  peace, education, and cultural preservation. In the decades
                  that followed, it expanded internationally, welcoming
                  qualified practitioners from around the world while remaining
                  committed to preserving the true spirit and traditions of
          ...
          <div className="max-w-5xl mx-auto">
            <div className="space-y-6 text-neutral-600 leading-relaxed">
              ...
              <p>
                ...
                research, and the maintenance of proper standards for
                instruction and conduct. Through these efforts, DNBK seeks to
                ensure the accurate continuation of martial culture and the
                integrity of Budo traditions.
              </p>
              <p>
